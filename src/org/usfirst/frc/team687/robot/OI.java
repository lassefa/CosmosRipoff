...
public class OI {
	...
	public Joystick artic = new Joystick(2);
	public Button driveForward = new JoystickButton(rightJoy, 1);
	public Button resetEncoders = new JoystickButton(leftJoy, 1);
	
	public OI() {
		driveForward.whenPressed(new DriveForward(75000));
